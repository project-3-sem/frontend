          ...
          <article className="home-card home-card--blue">
            ...
            <div className="home-card__content">
              <img
                ...
                alt="Звезды"
              />
              <h2 className="home-card__title">Проверка произношения</h2>
              <p className="home-card__subtitle">ИИ-ассистентом</p>
              <p className="home-card__text">
                Но я должен объяснить вам, как родилась вся эта ошибочная идея
                обличения удовольствия и восхваления боли, и я дам вам полное
                описание этой системы и изложу подлинное учение великого
                исследователя истины, мастера-строителя человеческого счастья.
              </p>
            </div>
          </article>
          ...
          <article className="home-card home-card--yellow">
            ...
            <div className="home-card__content">
              <img
                ...
                alt="Звезды"
              />
              <h2 className="home-card__title">Интерактивная панель с</h2>
              <p className="home-card__subtitle home-card__subtitle--muted">
                результатами
              </p>
              <p className="home-card__text">
                Но я должен объяснить вам, как родилась вся эта ошибочная идея
          ...
          <article className="home-card home-card--pink">
            ...
            <div className="home-card__content">
              <img
                ...
                alt="Звезды"
              />
              <h2 className="home-card__title">Читайте свой текст</h2>
              <p className="home-card__subtitle home-card__subtitle--muted">
